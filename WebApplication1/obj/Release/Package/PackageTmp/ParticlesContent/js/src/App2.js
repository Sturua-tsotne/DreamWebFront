var App = function() {
    ...
    var _meshes = {
        bear: { scale: 0.023, yOffset: -2.30, speed: 0.05, url: "/ParticlesContent/models/bear.json" },
        bison: { scale: 0.020, yOffset: -2.00, speed: 0.10, url: "/ParticlesContent/models/bison.json" },
        ...
        horse: { scale: 0.022, yOffset: -2.30, speed: 0.08, url: "/ParticlesContent/models/horse.json" },
        panther: { scale: 0.030, yOffset: -1.70, speed: 0.10, url: "/ParticlesContent/models/panther.json" },
        // rabbit:    { scale:0.040, yOffset:-1.00, speed:0.05, url:"models/rabbit.json" },
        wolf: { scale: 0.040, yOffset: -1.70, speed: 0.10, url: "/ParticlesContent/models/wolf.json" },
    };

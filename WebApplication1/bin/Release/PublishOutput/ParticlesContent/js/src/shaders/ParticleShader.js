var ParticleShader = {
    ...
    vertexShader: Utils.loadTextFileInject(
        "/ParticlesContent/shaders/ParticleShader.vs.glsl"
    ),

    fragmentShader: Utils.loadTextFileInject(
        "/ParticlesContent/shaders/ParticleShader.fs.glsl"
    )
...
var BasicParticleShader = {
    ...
    vertexShader: Utils.loadTextFile(
        "/ParticlesContent/shaders/BasicParticleShader.vs.glsl"
    ),

    fragmentShader: Utils.loadTextFile(
        "/ParticlesContent/shaders/BasicParticleShader.fs.glsl"
    )
